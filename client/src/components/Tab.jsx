  ...
  return (
    <>
      {responseData.map((tab, index) => (
        <div key={index} className='p-3 w-[12.75rem] h-[19rem] bg-white md:rounded-lg sm:shadow-xl hover:shadow-2xl shadow-slate-900 hover:scale-105 hover:z-10 max-md:border max-md:border-slate-900 max-[408px]:w-[11.25rem]'>
