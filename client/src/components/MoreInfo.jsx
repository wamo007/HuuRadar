  ...
  return (
    <div className='relative min-h-screen w-full place-items-center overflow-hidden bg-[url("/buildings.png")] bg-cover bg-gray-800' id='More'>
        <div className='py-4 w-11/12 max-w-7xl flex flex-col items-center justify-center gap-3'>
          <div ref={more1} className={`px-7 py-5 transition-all ease-in duration-700 ${isVisibleMore1 ? 'opacity-100' : 'opacity-0 translate-y-20'}`}>
          ...
          <div ref={more2} className='container py-4 mx-auto w-full flex max-md:flex-wrap justify-center items-center gap-5 md:gap-10'>
